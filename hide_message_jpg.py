#
# Bu kod, verilen bir JPEG görüntüye metni gizler ve sonucu kaydeder.
#

from PIL import Image

def MesajGizleJpg(yollananGoruntu, msj):
    gizlenecekDegerler = ""
    okunanBitler = ""
    ...
    for i in range(yollananGoruntu.width):
        for j in range(yollananGoruntu.height):
            ...
            okunanBitler += binary_R[-1]
            okunanBitler += binary_G[-1]
            okunanBitler += binary_B[-1]
    ...
    yollananGoruntu.save('images/image_hide_message_jpg.jpg')
